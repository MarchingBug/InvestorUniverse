    ...
    public class PriorityController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Priority1")] Priority priority)
        {
            if (ModelState.IsValid)
            {
                ...
                priority.CreatedBy = User.Identity.GetUserName();
        ...
        {
            var previous = from a in db.Priorities where a.Id == priority.Id select a;
            ...
            if (ModelState.IsValid)
            {
                priority.CreatedBy = creation.CreatedBy;
                priority.CreatedOn = creation.CreatedOn;
                priority.ModifiedBy = User.Identity.GetUserName();
